...
function getImageBuffer(filename) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    image = (0, sharp_1.default)("".concat(process.cwd(), "/assets/full/").concat(filename));
...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, width, height, cachedImg, imageBuffer, resizedImage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                cachedImg = getCachedImg(filename, width, height);
            ...
            case 1:
                imageBuffer = _a.sent();
                return [4 /*yield*/, (0, sharp_1.default)(imageBuffer).resize(width, height).toBuffer()];
            case 2:
                resizedImage = _a.sent();
                fs_1.default.writeFileSync(cachedImg, resizedImage);
                res.set('Content-Type', 'image/jpg');
